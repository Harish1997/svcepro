...
public class testfmechb extends Fragment{
    int x,y,z,t;
                ...
                switch (y) {
                    case 1: {
                        ...
                        switch (position) {
                            ...
                            case 3: {
                                ...
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/xDSKUy"));
                    ...
                    case 2: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/VUJMYz"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 3: {
                       // Toast.makeText(getActivity(),"third",Toast.LENGTH_SHORT).show();
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/zG21ml"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 4: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/5n4Tll"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 5: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/k4vQ5L"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 6: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/8TfmF6"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 7: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/h2NTho"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 8: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/woXy2Q"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
