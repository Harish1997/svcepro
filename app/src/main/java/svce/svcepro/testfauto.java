...
public class testfauto extends Fragment{
    int x,y,z,t;
                ...
                switch (y) {
                       ...
                       // Toast.makeText(getActivity(),"first",Toast.LENGTH_SHORT).show();
                        switch (position) {
                            ...
                            case 3: {
                                ...
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/rc4AyT"));
                    ...
                    case 2: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/fRz85O"));
                                startActivity(browserintent);
                    ...
                    case 3: {
                      //  Toast.makeText(getActivity(),"third",Toast.LENGTH_SHORT).show();
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/f1bYng"));
                                startActivity(browserintent);
                    ...
                    case 4: {
                        switch (position) {
                            ...
                            case 2: {
                                Toast.makeText(getActivity(), "Faculty Advisors", Toast.LENGTH_SHORT).show();
                                Intent newint = new Intent(getActivity(), facultyadv.class);
                                Toast.makeText(getActivity(),"sem is"+y+"year is"+x,Toast.LENGTH_SHORT).show();
                                newint.putExtra("sec", t);
                                newint.putExtra("year", x);
                                newint.putExtra("sem", y);
                                newint.putExtra("sel", z);
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/B5ZIxE"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 5: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/5scWh9"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 6: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/Wt5Rwt"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 7: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/woZLDK"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 8: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/XwpgQS"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
    ...
    public List<data> fill_with_data() {
        ...
        data.add(new data("Bus Schedule", "Make sure you keep a track of this after all life is a lottery,be lucky!", R.drawable.nbus));
