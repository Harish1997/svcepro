package svce.svcepro.tasks;

/**
 * Created by harishananth on 11/10/17.
 */
...
import svce.svcepro.navandtab;
import svce.svcepro.R;
...
public abstract class GenericRequestTask extends AsyncTask<String, String, TaskOutput> {
    ...
    public GenericRequestTask(Context context, navandtab activity, ProgressDialog progressDialog) {
    ...
    private URL provideURL(String[] coords) throws UnsupportedEncodingException, MalformedURLException {
        ...
        if (coords.length == 2) {
            ...
            final String city = sp.getString("city", "Chennai");
