...
public class testfcsea extends Fragment{
    int x,y,z,t;
                ...
                switch (y) {
                    case 1: {
                        ...
                        switch (position) {
                            ...
                            case 3: {
                                ...
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/kCQUvw"));
                    ...
                    case 2: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/asI29o"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 3: {
                       // Toast.makeText(getActivity(),"third",Toast.LENGTH_SHORT).show();
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/qK1NQK"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 4: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/UECSHn"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 5: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/IJKNac"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 6: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/4GFrxh"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 7: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/QjzCZd"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 8: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/jf3rgX"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
