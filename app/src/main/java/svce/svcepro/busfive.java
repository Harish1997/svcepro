...
public class busfive extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (isNetworkAvailable(getActivity())) {
            Glide.with(getActivity()).load("https://i.pinimg.com/736x/cf/e6/b8/cfe6b8c3361d2cdacedd7f4f55ff7b5c--night-sky-stars-starry-night-sky.jpg").into(img);
            root = FirebaseDatabase.getInstance().getReferenceFromUrl("https://svce-pro-26e5f.firebaseio.com/").child("buslast");

            root.addChildEventListener(new ChildEventListener() {
                @Override
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    buslast(dataSnapshot, v);
                }
    ...
    private void buslast(DataSnapshot dataSnapshot,View view)
    {
