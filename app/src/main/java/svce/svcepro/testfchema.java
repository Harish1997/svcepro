...
public class testfchema extends Fragment{
    int x,y,z,t;
                ...
                switch (y) {
                    case 1: {
                        ...
                        switch (position) {
                            ...
                            case 3: {
                                ...
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/pzPQHW"));
                    ...
                    case 2: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/MTuPYq"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                   ...
                   //     Toast.makeText(getActivity(),"third",Toast.LENGTH_SHORT).show();
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/ZLZzZR"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 4: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/LrKw9k"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 5: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/5wTHlM"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 6: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/ux2ayF"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 7: {
                        switch (position) {
                          ...
                          //      Toast.makeText(getActivity(), "Class Timetable Not Available", Toast.LENGTH_SHORT).show();
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/PoBC8O"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 8: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/zgwAwg"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
