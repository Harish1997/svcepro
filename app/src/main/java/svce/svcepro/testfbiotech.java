...
public class testfbiotech extends Fragment{
    int x,y,z,t;
                ...
                switch (y) {
                       ...
                       // Toast.makeText(getActivity(),"first",Toast.LENGTH_SHORT).show();
                        switch (position) {
                            ...
                            case 3: {
                                ...
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/pxOok3"));
                    ...
                    case 2: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/vPJ3LC"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 3: {
                       // Toast.makeText(getActivity(),"third",Toast.LENGTH_SHORT).show();
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/XbHSoT"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 4: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/fFVISR"));
                                startActivity(browserintent);;
                                break;
                            }
                            case 4: {
                    ...
                    case 5: {
                        switch (position) {
                            ...
                            case 1: {
                                Toast.makeText(getActivity(), "Bus Routes", Toast.LENGTH_SHORT).show();
                                Intent newint = new Intent(getActivity(), busfone.class);
                                newint.putExtra("json", 1);
                                startActivity(newint);
                                break;
                            }
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/O3yPXh"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 6: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/M1y38e"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 7: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/T1Yr5T"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 8: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/8JfTAy"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
