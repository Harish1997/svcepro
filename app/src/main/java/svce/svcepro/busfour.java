...
public class busfour extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (isNetworkAvailable(getActivity())) {
            Glide.with(getActivity()).load("http://www.shaynebenowitz.com/wp-content/uploads/2013/04/IMG_5906.jpg").into(img);
            root = FirebaseDatabase.getInstance().getReferenceFromUrl("https://svce-pro-26e5f.firebaseio.com/").child("buslate");

            root.addChildEventListener(new ChildEventListener() {
                @Override
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    buslate(dataSnapshot, v);
                }
    ...
    private void buslate(DataSnapshot dataSnapshot,View view)
    {
