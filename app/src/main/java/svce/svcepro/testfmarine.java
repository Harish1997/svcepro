...
public class testfmarine extends Fragment{
    int x,y,z,t;
                ...
                switch (y) {
                      ...
                      //  Toast.makeText(getActivity(),"first",Toast.LENGTH_SHORT).show();
                        switch (position) {
                            ...
                            case 3: {
                                ...
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://svcepro-my.sharepoint.com/personal/deaned_svcepro_onmicrosoft_com/_layouts/15/guestaccess.aspx?folderid=0c1bf958d36fc49a3ba8b003656237343&authkey=ARG-Dh9oI9la8niWqAypnMA"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                                Toast.makeText(getActivity(), "Question Papers", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://svcepro-my.sharepoint.com/personal/deaned_svcepro_onmicrosoft_com/_layouts/15/guestaccess.aspx?folderid=02d7c633373fe4f1a896d533d884b2456&authkey=AZlQlLRq55A2dtWH3aK5hx4"));
                                startActivity(browserintent);
                                break;
                            }
                            case 5: {
                    ...
                    case 5: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://svcepro-my.sharepoint.com/personal/deaned_svcepro_onmicrosoft_com/_layouts/15/guestaccess.aspx?folderid=07a8c6638017c4b9cadf3baab8a074118&authkey=AecmO5zIS677xveE-s_Rxa0"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
                    ...
                    case 7: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent browserintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://svcepro-my.sharepoint.com/personal/deaned_svcepro_onmicrosoft_com/_layouts/15/guestaccess.aspx?folderid=06a2a7b7a2cf14ca4a81e75df5b57634e&authkey=ARLCiktDjiMMV-0K2sQwSNM"));
                                startActivity(browserintent);
                                break;
                            }
                            case 4: {
