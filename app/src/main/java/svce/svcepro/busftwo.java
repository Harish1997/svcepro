...
public class busftwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (isNetworkAvailable(getActivity())) {
            Glide.with(getActivity()).load("https://www.music-bazaar.com/album-images/vol29/1068/1068498/2934293-big/Afternoon-Vibes-cover.jpg").into(img);
            root = FirebaseDatabase.getInstance().getReferenceFromUrl("https://svce-pro-26e5f.firebaseio.com/").child("busafternoon");

            root.addChildEventListener(new ChildEventListener() {
                @Override
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    busafternoon(dataSnapshot, v);
                }
    ...
    private void busafternoon(DataSnapshot dataSnapshot,View view)
    {
